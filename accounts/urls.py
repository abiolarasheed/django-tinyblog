...
urlpatterns = [
    ...
    path('dashboard/my-posts/', DashBoardEntryListView.as_view(), name='dashboard-entries'),
    path('dashboard/update-profile/<int:pk>/', EditProfileView.as_view(), name='update-profile'),
